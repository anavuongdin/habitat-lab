...
from habitat_baselines.rl.ddppo.policy.vae import create_vae_model
...
class VAENet(nn.Module):
    def __init__(
        ...
        self.vae = create_vae_model(in_channels, base_planes)
        self.cardinality = cardinality
        self.inplanes = base_planes
        self.final_channels = self.inplanes
        self.final_spatial_compress = 1.0 / (2**2)
